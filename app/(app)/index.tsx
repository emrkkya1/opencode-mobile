      ...
      if (item.type === "header") {
        return (
          <View className="px-4 pt-4 pb-2">
            <Text className="text-xs font-semibold text-text-weak uppercase">
              {item.title}
            </Text>
          </View>
        )
      ...
      {items.length === 0 ? (
        ...
        <FlashList
          ...
          ItemSeparatorComponent={() => (
            <View className="h-px bg-border-weak ml-12" />
          )}
        />
      )}
    </View>
